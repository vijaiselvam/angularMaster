...
export class AppComponent {
  ...
  columnDefs = [
    { headerName: 'Athlete', field: 'athlete', sortable: true, filter: true, resizable: true, pinned: 'left' },
    { headerName: 'Age', field: 'age', maxWidth: 120 },
    { headerName: 'Country', field: 'country', maxWidth: 120 },
    { headerName: 'Year', field: 'year', maxWidth: 120 },
    { headerName: 'Date', field: 'date', maxWidth: 120, filter: 'date' },
    { headerName: 'Sport', field: 'sport' },
    { headerName: 'Gold', field: 'gold' },
    { headerName: 'Silver', field: 'silver', maxWidth: 160 },
    { headerName: 'Bronze', field: 'bronze', maxWidth: 100 },
